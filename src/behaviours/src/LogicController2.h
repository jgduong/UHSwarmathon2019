#ifndef LOGICCONTROLLER2_H
#define LOGICCONTROLLER2_H
...
struct PrioritizedController2 {
  int priority = -1;
  Controller* controller = nullptr;

  PrioritizedController2(int pri, Controller* cntrl) :
    priority(pri),
    controller(cntrl)
  {
  }

  inline bool operator <(const PrioritizedController2& other) const
  {
    return priority < other.priority;
  }
};

class LogicController2 : virtual Controller
{
public:
  LogicController2();
  ~LogicController2();
